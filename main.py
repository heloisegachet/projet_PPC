...
def solver_test(type_instance):
	...
	if type_instance == "n_queens":
		n=4
		problem.n_queens(n, is_FC, is_MAC)
		#AC3(problem, infos=False)
		#AC4(problem, infos=False)
		backtrack(problem, infos=True)
	...
	if type_instance == "colorability":
		...
		problem.colorability(E, is_FC, is_MAC)
		AC4(problem)
		backtrack(problem, infos=False)
		print("solution finale : ", problem.inst)
